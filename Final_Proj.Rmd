...
The aim is to reproduce figures presented in the article published on FiveThirtyEight: \textit{Marriage Isn’t Dead — Yet}. The article is available here: https://fivethirtyeight.com/features/marriage-isnt-dead-yet/.

Data are available via on the FiveThirtyEight GitHub (https://github.com/fivethirtyeight/data/tree/master/marriage), but are also included in the `data` folder of this repo. First we load the data:
